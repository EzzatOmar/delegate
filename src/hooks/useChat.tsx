...
import { BotSettings, BotState, useBot } from "./useBot";
 ...
 * Updates the store
 */
async function addMessage(message: Omit<ChatMessage, "id" | "unixTimestamp">, opts?: {onBotResponseHandler?: (params: [response: any, gErr: GlobalError | null]) => void}):Promise<GlobalError | null> {
