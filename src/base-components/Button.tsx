...
export default function Button(props: ButtonProps) {
  ...
  return <button ref={mergeRefs(el => (ref = el), props.ref)}
    ...
    classList={{
      ...
      'bg-warning-500 hover:bg-warning-600': props.variant === 'warning' && !props.outline,
      ...
      'border-2 border-warning-500 hover:bg-warning-500 text-warning-500 hover:text-canvas-900': props.variant === 'warning' && props.outline,
